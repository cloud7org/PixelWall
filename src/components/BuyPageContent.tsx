  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: isMobile ? 'column' : 'row', overflow: 'hidden' }}>
      ...
      >
        ...
        <button
          type="submit"
          disabled={uploading || isOverlap || !privacyConsent || !termsConsent}
          style={{
            width: '100%', background: uploading || isOverlap || !privacyConsent || !termsConsent ? '#2A2C36' : '#2EE6A6',
            color: uploading || isOverlap || !privacyConsent || !termsConsent ? '#5A5C66' : '#1A0A05',
            fontFamily: 'var(--font-space-grotesk), sans-serif', fontWeight: 700, fontSize: 15,
            padding: 16, border: 'none', cursor: uploading || isOverlap || !privacyConsent || !termsConsent ? 'not-allowed' : 'pointer',
          }}
        >
